import { readSheetData } from '../services/googleSheetService.js';
...
async function main() {
  try {
    const rows = await readSheetData(sheetId, "'SmsLogs'!A1:F50", clientEmail, privateKey);
    console.log('--- SHEET SMS LOGS DATA ---');
