...
// Dynamically import jose (it is an ESM package, so we can import it dynamically or use standard fetch if we can sign it)
// Wait, we can import 'jose' dynamically in CommonJS using dynamic import()!
async function run() {
